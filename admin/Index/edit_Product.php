				...
				<div class="container-fluid body-area mt-5">
					...
					<div class="row mt-3">
						...
						<div class="col-md-12 col-sm-12">
							<h5 class="pt-4"><a href="/E-Commerce/ecom/admin/Index/index.php"
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 lower-area mt-5 p-2">
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="/E-Commerce/ecom/admin/Index/Sql/p_edit.php"  method="post" enctype="multipart/form-data">
										<div class="row p-1">
