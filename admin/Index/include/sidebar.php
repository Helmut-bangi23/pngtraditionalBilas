				...
				<div class="das_icon" id="navi">
					<nav>
						...
						<a href="#" style="margin-top: 10px;" onclick="show()"><i class="fab fa-product-hunt"
								...
								id="drop1"></i></a>
						<div id="submenu">
							<a href="/E-Commerce/ecom/admin/Index/Add_Product.php"><i class="fas fa-plus"></i> Add</a>
							<a href="/E-Commerce/ecom/admin/Index/view.php"><i class="fas fa-eye"></i> View</a>
						...
						<div id="submenu2">
							...
							<a href="/E-Commerce/ecom/admin/Index/orderview.php"><i class="fas fa-eye"></i> View</a>
						</div>
						...
						<div id="submenu3">
							<a href="/E-Commerce/ecom/admin/Index/customerview.php"><i class="fas fa-eye"></i> View</a>
						</div>
