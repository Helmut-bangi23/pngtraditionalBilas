...
<body>
	...
	<div class="box-form">
		<div class="left">
			<div class="overlay">
				...
				<span>
					...
					<a href="https://www.facebook.com/profile.php?id=61560013690910"><i class="fa fa-facebook" aria-hidden="true"></i></a>
		...
		<div class="right">
			...
			<!--<form action = "/E-commerce/ecom/admin/Login/Sql/adminlog.php" class="form" method="post">-->
