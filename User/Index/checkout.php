  ...
  <h1 class="btn btn-primary"> Order Now!!!</h1>
      ...
      <div class="row mt-1 mb-1" style="margin-left:165px;">
        ...
        <div class="col-md-12 col-sm-12">
          <h5 class="pt-2"><a href="/E-Commerce/ecom/User/Index/index.php"
        ...
        while ($row = mysqli_fetch_array($table)) {
         ?>
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><img src="/E-Commerce/ecom/admin/index/img/uploads/<?php echo $row['product_image'];?>"
