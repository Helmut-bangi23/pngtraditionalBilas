...
<div class="container-fluid body-area mt-1">
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 col-sm-12 mt-1">
      <h5 class="pt-2 ml-2"><a href="/E-Commerce/ecom/User/Index/index.php"
          style="text-decoration: none; font-weight: bold;">Select product</a>
      </h5>
    </div>

    <div class="col-md-2 col-sm-12">
      <h5 class="pt-2"><a href="/E-Commerce/ecom/User/Index/vieworder.php" class="btn btn-success">Go to my orders</a>
      </h5>
    </div>
            ...
            if(mysqli_num_rows($table)>0){
              ...
              <tr>
                ...
                <td style="text-align:center;">
                  <img src="/E-Commerce/ecom/admin/index/img/uploads/<?php echo $row['product_image'];?>"
...
?>
    ...
    <div class="col-md-2 col-sm-12 mb-3 mt-2">
      <a href="/E-Commerce/ecom/User/Index/checkout.php" class="btn btn-primary">Proceed to checkout</a>
    </div>
