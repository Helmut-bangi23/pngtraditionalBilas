...
<body>
	...
	<div class="box-form">
		...
		<div class="right">
			<h5>SignUp</h5>
			<p style="font-weight:bold;">For Your New Customer Account<a href="/E-commerce/ecom/User/index.php" style="text-decoration:none; font-weight:bold; font-size:large; cursor:pointer;"> Login Now </a></p>
